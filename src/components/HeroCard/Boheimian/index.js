        ...
        <div className={"ContactUsB"}>
                ...
                <div className="max-w-max mx-auto flex flex-col lg:flex-row lg:items-center pr-4 ">
                    ...
                    <div className="lg:ml-16 mt-8 lg:mt-0 p-4 lg:p-0">
                        ...
                        <div className={`priceTag w-[246px] h-[53px] lg:w-[278px] lg:h-[61px] mt-10`}>
                            <span className="font-medium text-[32px] whitespace-nowrap leading-[29px] lg:text-[40px] lg:leading-[37px]">$ 317,000</span>
            ...
            <div className=" lg:py-[120px]">
                ...
                <section className={"cardSection"}>
                    ...
                    <div className={`max-w-max mx-auto flex flex-col lg:flex-row lg:justify-end items-center p-4 lg:p-5 backgroundSectionFirst`}>
                ...
                <section className={"cardSection"}>
                    ...
                    <div className={`max-w-max mx-auto  flex flex-col lg:flex-row lg:justify-end py-5 items-center px-4 lg:px-12 backgroundSectionSecond`}>
                        <div className={`p-4 lg:p-10 mt-60 lg:mt-0 w-full lg:w-auto content`}>
                            <h4 className="font-bold text-[24px] leading-[24px] lg:text-[36px] lg:leading-[41px]">11 5152 Canada Way, Burnaby</h4>
                            <h5 className="text-[18px] leading-[26px] lg:text-[24px] lg:leading-[35px]">Keller Williams Realty VanCentral</h5>
                            <div className={`priceTag w-[246px] h-[53px] lg:w-[278px] lg:h-[61px] mt-10`}>
                                <span className="font-medium text-[32px] leading-[29px] lg:text-[40px] lg:leading-[37px] whitespace-nowrap">$ 317,000</span>
                                <span className="flex items-center">
                                <span className={"off"}>20%</span>
                                <img src={arrowDown} alt="arrow down"/>
                            </span>
