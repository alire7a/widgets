    ...
    return (
        <div className="HeroCardC lg:py-[120px]">
            <section className={"cardSection"}>
                    ...
                    <div className="flex justify-center items-center -translate-y-1/2">
                        <button className={`arrowBtn mr-10 lg:mr-5`}>
                            <svg width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16.2724 21.8711L9.26159 14.8603C8.43364 14.0324 8.43364 12.6775 9.26159 11.8496L16.2723 4.83881" stroke="black" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                        ...
                        <button className={`${"arrowBtn"} ml-10 lg:ml-5`}>
                            <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.2276 21.8711L17.2384 14.8603C18.0664 14.0324 18.0664 12.6775 17.2384 11.8496L10.2277 4.83881" stroke="black" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                    </div>
                </div>
                <div className="max-w-max mx-auto flex flex-col lg:flex-row lg:items-center px-4 ">
                    ...
                    <div className="lg:pl-8 mt-8 lg:mt-0">
                        ...
                        <div className={`${"priceTag"} w-[246px] h-[53px] lg:w-[278px] lg:h-[61px] mt-10`}>
                            <span className="font-medium text-[32px] leading-[29px] whitespace-nowrap lg:text-[40px] lg:leading-[37px]">$ 317,000</span>
            ...
            <section className={"cardSection"}>
                ...
                <div className={` max-w-max mx-auto flex flex-col h-[400px] lg:h-full lg:flex-row lg:justify-end items-center mx-4 p-0 lg:p-5 ${"backgroundSection"}`}>
                    <div className={`p-4 lg:p-10 mt-60 lg:mt-0 w-full lg:w-auto ${"content"}`}>
                        <h4 className="font-bold text-[24px] leading-[24px] lg:text-[36px] lg:leading-[41px]">11 5152 Canada Way, Burnaby</h4>
                        <h5 className="text-[18px] leading-[26px] lg:text-[24px] lg:leading-[35px]">Keller Williams Realty VanCentral</h5>
                        <div className={`${"priceTag"} w-[246px] h-[53px] lg:w-[278px] lg:h-[61px] mt-10`}>
                            <span className="font-medium text-[32px] leading-[29px] lg:text-[40px] whitespace-nowrap lg:leading-[37px]">$ 317,000</span>
                            <span className="flex items-center">
                                <span className={"off"}>20%</span>
                                <img src={arrowDown} alt="arrow down"/>
                            </span>
            ...
            <section className={`mt-72 mb-72 lg:my-16 ${"cardSection"}`}>
                ...
                <div className={` max-w-max mx-auto flex flex-col h-[400px] lg:h-[500px] lg:flex-row lg:justify-end py-5 items-center mx-4 lg:px-12 ${"backgroundSection"}`}>
                    <div className={`p-4 lg:p-10 mt-60 lg:mt-[480px] w-full lg:w-auto ${"content"}`}>
                        <h4 className="font-bold text-[24px] leading-[24px] lg:text-[36px] lg:leading-[41px]">11 5152 Canada Way, Burnaby</h4>
                        <h5 className="text-[18px] leading-[26px] lg:text-[24px] lg:leading-[35px]">Keller Williams Realty VanCentral</h5>
                        <div className={`${"priceTag"} w-[246px] h-[53px] lg:w-[278px] lg:h-[61px] mt-10`}>
                            <span className="font-medium text-[32px] leading-[29px] whitespace-nowrap lg:text-[40px] lg:leading-[37px]">$ 317,000</span>
