    ...
    return (
        <div className="lg:px-[90px] lg:py-[120px]">
            ...
            <section className={style.cardSection}>
                ...
                <div className={` max-w-max mx-auto flex flex-col h-[400px] lg:h-full lg:flex-row lg:justify-end items-center mx-4 p-0 lg:p-5 ${style.backgroundSection}`}>
            ...
            <section className={`mt-72 mb-72 lg:my-16 ${style.cardSection}`}>
                ...
                <div className={` max-w-max mx-auto flex flex-col h-[400px] lg:h-[500px] lg:flex-row lg:justify-end py-5 items-center mx-4 lg:px-12 ${style.backgroundSection}`}>
