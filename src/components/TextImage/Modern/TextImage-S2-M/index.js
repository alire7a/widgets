...
const TextImageS2M = () => {
    return (
        ...
        <div className={`TextImageS2M border-1 border-[#E8EBFF]    max-w-max mx-auto  lg:gap-24  rounded-t-12 `}>
            <div className={"flex lg:absolute top-0 left-0 right-0 mx-auto flex-col lg:w-[432px] lg:h-[432px]  lg:rounded-12 overflow-hidden "}>
                <img className={"w-full rounded-12 h-full mt-auto   object-cover "} src="/media/firstfold/Rectangle 38.png" alt=""/>
            </div>

            <div className="text-container bg-[#F8F9FF] lg:pt-32 lg:text-center lg:bg-white flex flex-col lg:justify-center items-center lg:items-start p-8 lg:p-16 " >
              <div className={"flex mx-auto relative z-10 rounded-8 bg-white p-5 -mt-24 mb-5 flex-col lg:flex-row lg:gap-4 items-center lg:mb-4"}>
                  <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M21.97 22.8899H19.03C17.76 22.8899 17 23.6499 17 24.9199V27.8599C17 29.1299 17.76 29.8899 19.03 29.8899H21.97C23.24 29.8899 24 29.1299 24 27.8599V24.9199C24 23.6499 23.24 22.8899 21.97 22.8899ZM22.17 26.5499L20.5 28.4499L20.3 28.6799C20.03 28.9899 19.8 28.9099 19.8 28.4899V26.7099H19.04C18.69 26.7099 18.6 26.4999 18.83 26.2399L20.5 24.3399L20.7 24.1099C20.97 23.7999 21.2 23.8799 21.2 24.2999V26.0799H21.96C22.31 26.0699 22.4 26.2899 22.17 26.5499Z" fill="#416F8B"/>
                  </svg>

                  <h2 className="title text-[#416F8B] mb-4 lg:mb-0     text-32  ">OUR TEAM</h2>
              </div>
