    ...
    return (
        <div className={" relative lg:px-20 "}>
            ...
            <div className={`${s.container}  relative max-w-max mx-auto lg:items-center  lg:flex gap-10   `}>
                    ...
                    <div className={"flex absolute overflow-hidden mb-8 lg:h-full lg:mb-0 lg:mr-20"}>
                ...
                <div className="absolute text-container w-[300px] left-4 bg-white px-10 lg:w-[800px] flex flex-col  lg:items-start  py-8 lg:p-0  " >
                  <div className={"flex flex-col   mb-24"}>
                      <h2 className="title text-[#545650] mb-2 lg:mb-0     text-48  ">OUR TEAM</h2>
                      <div className={"fasthand text-[#A2A798] text-24 font-light"}>
                          Prop Trader
                      </div>
                  </div>
                    <div className={"since mb-4"}>
                        Since 11 March 1997
                    </div>
