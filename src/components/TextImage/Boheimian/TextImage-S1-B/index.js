...
const TextImageS1B = () => {
    return (
        <div className={"px-4 relative lg:px-20"}>

            <div className={`${s.container} relative max-w-max mx-auto   lg:flex lg:items-end gap-10   `}>
                ...
                <div className={"flex  overflow-hidden "}>
                    <img className={" mt-auto h-[655px] lg:h-[900px] rounded-t-[260px] lg:w-[550px]  object-cover "} src="/media/firstfold/Rectangle 38.png" alt=""/>
                </div>
            ...
            <div className="text-container lg:w-[400px] flex flex-col  lg:items-start  py-8 lg:p-0  " >
              <div className={"flex flex-col  border-b-1 border-[#D9D9D9] mb-6"}>
                  ...
                  <h2 className="title text-[#545650] mb-5 lg:mb-0     text-48  ">OUR TEAM</h2>
              </div>
                <div className={"since mb-12"}>
                    Since 11 March 1997
                </div>
