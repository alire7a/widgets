    ...
    return (
        <div className={"lg:px-[90px] lg:py-[120px] overflow-hidden"}>
            ...
            <div className={"max-w-max mx-auto relative mt-20 h-[550px] "}>
                <div className={`absolute w-full h-full lg:w-[70%] h-full flex z-10 items-end p-12 rounded-16 `}>
                ...
                <div className={`max-w-max mx-auto relative flex justify-end items-center mt-20 h-[590px] lg:h-[700px] rounded-16 `}>
                    <img className={"w-full h-full absolute inset-0  object-cover"} src="/media/text-only.png" alt=""/>
                    <div className={`h-full z-10 flex items-end pb-20 mr-10 lg:mr-24 px-5 lg:px-12 lg:rounded-16 ${style.designBackground}`}>
