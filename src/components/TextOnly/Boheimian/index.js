...
import style from "./TextOnlyB.module.scss"
const TextOnlyC = () => {
    return (
        <div className={`lg:px-[90px] lg:py-[120px] ${style.container}`}>
            ...
            <div className="w-full flex flex-col lg:flex-row justify-center lg:items-center lg:justify-between mb-16 py-11 rounded-16">
