...
const HeaderS12C = () => {
    return (
        <header className={`HeaderS12C text-white text-center  relative  `}>
            ...
            <div className={`mx-auto relative z-[3] lg:h-[834px] p-4 lg:p-10`}>
                <nav className={`w-full mb-32 max-w-max py-1 px-4 mx-auto items-center lg:px-11 lg:py-[15px]  flex justify-between text-white`}>
                    <img className={"w-16 lg:hidden"} src="/media/firstfold/WATERMARK_TheActualized-04 2.png" alt=""/>
                    ...
                    <span className={`flex ml-auto roboto text-12 sm:text-14  flex-col items-end`}>
                ...
                <div className={`flex flex-col justify-center`}>
                    <h1 className={`font-bold mb-2 text-40 lg:text-64 lg:leading-[85px] tracking-[0.24em]`}>
                        FIRST FOLD
                    </h1>
                    <h2 className={`text-16 tracking-[-0.04em] lg:text-36 lg:leading-[42px] mb-32 lg:tracking-[-0.04em] roboto font-light`}>
