        ...
        <header className={`HeaderS13C text-white relative text-center `}>
            ...
            <div className={`relative z-10 lg:h-[834px]  p-4 lg:p-10`}>
                <nav className={`w-full lg:px-11 lg:py-[15px] `}>
                    <img src="/media/firstfold/WATERMARK_TheActualized-04 2.png" className={"w-16 mx-auto mb-10"} alt=""/>
                    <ul
                        className={`hidden lg:flex list-none justify-center child:pr-6`}
                    >
                        <li>Home</li>
                        <li>Projects</li>
                        <li>Plans</li>
                    ...
                    <span className={`flex justify-center text-12 sm:text-14 gap-6 roboto items-center mb-16`}>
