...
const HeaderS12M = () => {
    return (
        <header className={`text-white relative text-center `}>
            ...
            <img className={"absolute lg:rounded-16 inset-0 -z-10 w-full h-full  object-cover"} src="/media/firstfold/Rectangle 47.png" alt=""/>
            <div className={` mx-auto lato relative z-[3] lg:h-[834px] p-4  lg:p-10 lg:pt-0`}>
                <nav className={`w-full bg-red relative bottom-12 lg:bottom-10 mb-16 max-w-max py-1 px-4 mx-auto items-center bg-white/40 lg:rounded-12 backdrop-blur-[60px] lg:px-11 lg:py-[15px] flex justify-between text-black`}>
                    <img className={"w-16 lg:hidden"} src="/media/firstfold/WATERMARK_TheActualized-04 1.png" alt=""/>
                    ...
                    <span className={`flex ml-auto roboto text-14 sm:text-14  flex-col items-end`}>
                ...
                <div className={` flex flex-col justify-center `}>
                    <h1 className={`font-bold mb-2 text-40  lato lg:text-64 lg:leading-[85px] tracking-[0.24em]`}>
                        FIRST FOLD
                    </h1>
                    <h2 className={`text-16  tracking-[-0.04em] lg:text-36 lg:leading-[42px] mb-6 lg:tracking-[-0.04em] roboto font-light`}>
                    ...
                    <div className={`mt-4  flex justify-center `}>
                        ...
                        <button className={`bg-white p-5 rounded-r-8`}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.4297 5.93L20.4997 12L14.4297 18.07" stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3.5 12H20.33" stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                    </div>
                    <div className={`flex justify-center py-4 px-8 backdrop-blur mb-40 px-4 w-full lg:w-[45%] mx-auto justify-between text-left  mt-8`}>
