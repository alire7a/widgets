    ...
    return (
        <header className={` HeaderS11M text-white relative text-center `}>
            ...
            <div className={` mx-auto lato relative z-[3] lg:h-[834px] p-4  lg:p-10`}>
                <nav className={`w-full mb-16 max-w-max py-1 px-4 mx-auto items-center lg:px-11 lg:py-[15px] flex justify-between text-black`}>
                ...
                <div className={` flex flex-col justify-center `}>
                    <h1 className={`font-bold mb-2 text-[#363853] text-40  lato lg:text-64 lg:leading-[85px] tracking-[0.24em]`}>
                        FIRST FOLD
                    </h1>
                    <h2 className={`text-16 text-[#363853] tracking-[-0.04em] lg:text-36 lg:leading-[42px] mb-16 lg:tracking-[-0.04em] roboto font-light`}>
                    ...
                    <div className={`flex justify-center mb-40 text-[#363853] px-4 w-full lg:w-[40%] mx-auto justify-between text-left  mt-8`}>
