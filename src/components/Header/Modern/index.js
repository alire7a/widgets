    ...
    <>
      <header className={`text-white text-center ${styles.headerBackground}`}>
        <div className={` mx-auto  px-4  lg:p-10`}>
          <nav className={`w-full max-w-max items-center mx-auto bg-black py-4 px-7 lg:px-11 lg:py-[15px] flex  text-white`}>
          ...
          <div className={`h-[90%] max-w-max mx-auto flex-col lg:flex-row flex mt-4 lg:mt-[32px] justify-between`}>
